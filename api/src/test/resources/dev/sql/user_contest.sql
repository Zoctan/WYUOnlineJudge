...
CREATE TABLE `user_contest` (
  ...
  CONSTRAINT `user_contest_fk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_contest_fk_2` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户比赛表';
...
INSERT INTO `user_contest` VALUES (2, 2);
INSERT INTO `user_contest` VALUES (2, 4);
