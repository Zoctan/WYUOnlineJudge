...
CREATE TABLE `contest` (
  ...
  `after_show` tinyint(1) DEFAULT '0' COMMENT '是否在结束后公开题目：0否 | 1是',
...
INSERT INTO `contest` VALUES (1,'2018级C语言考试','<img src="http://p8x4fj91m.bkt.clouddn.com/exam.png" style="width: 100%;height: 100%;"><p>考试形式：闭卷</p><p>考试地点：综合实验楼201</p><p>考试安排：统考</p><p>考试内容：书内重点','2018-07-01 14:45:00','2018-07-01 15:45:00',0,0,0,NULL);
INSERT INTO `contest` VALUES (2,'滴滴Di-Tech算法大赛校内选拔赛','<img src="https://img-hxy021.didistatic.com/static/ditech/2017/11/10/chinese_1507550686120_1510259595481.jpg" style="width: 100%;height: 100%;"><p>滴滴Di-Tech算法大赛是由滴滴主办、面向全球技术人才的系列赛事。通过开放海量的真实出行数据，用最前沿热门的研究课题，向全球征集更聪明的解决方案，优秀成果有机会将其应用于滴滴的产品端，用科技颠覆全世界数以亿计用户的出行体验。第三届大赛总奖池100万人民币，竞赛主题是“智慧信号灯”，诚邀全球的算法天才们走进智慧交通的世界，寻找“拥堵”这一世界性难题的解决方案。</p>','2018-08-01 09:00:00','2018-08-02 09:00:00',1,0,1,'$2a$10$g9RoFByPg9/O9RR/GKfmX.QCP0eJ1eThjTXq5d/QZFejuaEWMF0yK');
INSERT INTO `contest` VALUES (3,'2018级数据结构考试','<img src="http://p8x4fj91m.bkt.clouddn.com/exam.png" style="width: 100%;height: 100%;"><p>考试形式：闭卷</p><p>考试地点：综合实验楼202</p><p>考试安排：统考</p><p>考试内容：书内重点','2018-09-01 08:15:00','2018-09-01 09:45:00',0,0,0,NULL);
INSERT INTO `contest` VALUES (4,'校内ACM培训赛','<img src="http://p8x4fj91m.bkt.clouddn.com/training.jpg" style="width: 100%;height: 100%;">为第二届ACM比赛做准备的培训赛','2018-01-01 08:15:00','2018-07-01 08:15:00',0,1,1,NULL);
INSERT INTO `contest` VALUES (5,'第一届校内ACM比赛','<img src="http://p8x4fj91m.bkt.clouddn.com/ACM.jpg" style="width: 100%;height: 100%;">ACM/ICPC程序设计大赛有着悠久的历史，是国际上最受认可最具权威的程序设计大赛。计算机学院将展开ACM程序设计大赛，并为参赛选手开展培训讲座。通过比赛发掘校内高水平人才，为即将来临的广东省ACM程序设计大赛做好准备，以展现我校学生在程序设计方面的能力，为我校增添荣誉；同时也借此机会向广大同学介绍我校的ACM赛事，让有意深造者加入ACM团队，并为广东省ACM程序设计大赛输送人才。','2018-06-20 09:00:00','2018-06-20 12:00:00',1,0,1,NULL);
